...
public class EarthQuakeClient2 {
    ...
    public void quakesWithFilter() {
        ...
        /*
         * Location denver = new Location(39.7392, -104.9903); float max = 1000000; //
         * 1,000,000 m or 1,000 km Filter f = new DistanceFilter(denver, max);
         * ArrayList<QuakeEntry> answer = filter(list, f); System.out.println("Found " +
         * answer.size() + " earthquakes "); f = new PhraseFilter("end", "a"); answer =
         * filter(answer, f); for (QuakeEntry qe : answer) { System.out.println(qe); }
         */
    ...
    public void testMatchAllFilter2() {
        ...
        maf.addFilter(f);
        // Filter for distance from Billund, Denmark less than 3,000,000 meters (3000
        // km)
