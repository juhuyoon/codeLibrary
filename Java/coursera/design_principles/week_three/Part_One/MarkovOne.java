...
public class MarkovOne {
    ...
    //predicts the next characters by finding the characters in the training text, and then randomly picking one of them as the next character.
    public String getRandomText() {
        ...
        for(int k = 0; k < numChars -1; k++) {
           ...
           index = myRandom.nextInt(folllows.size());
