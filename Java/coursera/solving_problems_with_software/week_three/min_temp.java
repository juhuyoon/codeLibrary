...
public class minTemp {
        ...
        CSVRecord coldestTemp = null;
         for(CSVRecord currRow : parser) {
            if(coldestTemp == null) {
                ...
                double currTemp = Double.parseDouble("TemperatureF");
    ...
    public void testColdestHourInFile() {
        ...
        System.out.println(lowestTemp.get("TemperatureF") + " : " + lowestTemp("DateUTC"));
    }
    ...
    public void testFileWithColdestTemperature() {
        ...
        System.out.println("Coldest day in file : " + fileName);
